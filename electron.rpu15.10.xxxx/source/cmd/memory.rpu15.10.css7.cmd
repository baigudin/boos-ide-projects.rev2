...
SECTIONS
{
  ...
  .special   : {
                 "driver.Adc.obj"         (.text)
                 "driver.Adc.ll.obj"      (.text)
                 "driver.FullBridge.obj"  (.text)
                 "driver.Interrupt.obj"   (.text)
                 "driver.Pll.obj"         (.text)
                 "driver.Pwm.obj"         (.text)
                 "driver.System.ll.obj"   (.text)
                 "main.rpu15.10.3530.obj" (.text)
               /*"main.rpu15.10.4810.obj" (.text)*/
